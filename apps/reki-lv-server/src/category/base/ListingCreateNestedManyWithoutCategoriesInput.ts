...
@InputType()
class ListingCreateNestedManyWithoutCategoriesInput {
...
export { ListingCreateNestedManyWithoutCategoriesInput as ListingCreateNestedManyWithoutCategoriesInput };
